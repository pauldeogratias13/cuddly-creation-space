/**
 * use-content-creator.ts
 *
 * Manages content creation, user profiles, follows, and social features
 * for content creators. Users can:
 * - Create and post their own video content
 * - View their posted content on their profile
 * - Follow/unfollow other creators
 * - See their followers and following list
 * - Share content
 */
