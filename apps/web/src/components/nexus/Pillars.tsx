...
const pillars = [
  ...
  },
  {
    ...
    features: [
      "CLIP vision product search",
      "Escrow-protected payments",
      "Buy Now Pay Later",
      "Seller real-time dashboard",
      "Live shopping + add-to-cart",
    ],
    section: "§02B",
    accent: "amber",
  },
  {
    ...
    features: [
      "Intent-first / mood-aware feed",
      "Forked & remixed content trees",
      "Domain reputation graph",
      "Creator monetisation tools",
      "Anonymous persona switching",
    ],
    section: "§02C",
    accent: "violet",
  },
  {
    ...
    features: [
      "AV1 · SVT-AV1 codec",
      "Per-title ML bitrate ladder",
      "4K HDR · Dolby Atmos",
      "VMAF ≥ 93 quality gate",
      "Watch Together · synced parties",
    ],
    section: "§07",
    accent: "pink",
  },
  {
    ...
    features: [
      "Privacy browser · tracker-blocking",
      "Fingerprint spoofing",
      "Drag-and-drop site builder",
      "Custom domain support",
      "Intent-aware — no context hijacking",
    ],
    section: "§02D",
    accent: "emerald",
  },
  {
    ...
    features: [
      "WebRTC cloud gaming 60fps",
      "Esports bracket creation",
      "Fantasy leagues + live scores",
      "Party games from chat",
      "Rewarded opt-in ads for XP",
    ],
    section: "§02E",
    accent: "amber",
  },
  {
    ...
    features: [
      "V8 isolate / Docker sandbox",
      "NEXUS SSO bridge",
      "OAuth 2.1 scoped API access",
      "appname.nexus.app routing",
      "20% platform fee · 80% to owner",
    ],
    section: "§03",
    accent: "violet",
  },
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.05]">
            One app. <span className="text-gradient-aurora">Seven pillars.</span>{" "}
            <span className="text-muted-foreground">Every experience.</span>
          </h2>
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
            NEXUS is not a feature aggregation. It's a living digital ecosystem where each pillar is
            a first-class, natively built experience — no external app dependencies.
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-5">
                  <div
                    className={`h-11 w-11 rounded-lg ${a.bg} border border-border grid place-items-center ${a.border} transition-colors`}
                  >
                    <Icon className={`h-5 w-5 ${a.text}`} strokeWidth={1.75} />
                  </div>
                  <span className="font-mono-display text-xs text-muted-foreground/50">
                    {p.section}
                  </span>
                </div>
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-2xl sm:text-3xl font-semibold leading-snug">
                NEXUS never integrates third-party apps via APIs. Every experience is built natively
                or hosted inside the NexOS sandbox — one consistent, private environment.
              </p>
