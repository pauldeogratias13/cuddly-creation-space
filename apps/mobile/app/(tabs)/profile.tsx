...
export default function ProfileScreen() {
  ...
  const mockPosts = [
    { id: '1', text: 'Just launched our new app! 🚀', likes_count: 42, created_at: new Date().toISOString() },
    { id: '2', text: 'Beautiful sunset today 🌅', likes_count: 28, created_at: new Date(Date.now() - 86400000).toISOString() },
    { id: '3', text: 'Working on something exciting...', likes_count: 15, created_at: new Date(Date.now() - 172800000).toISOString() },
  ];
    ...
    <ScrollView className="flex-1 bg-gray-50">
      ...
      <View className="bg-white p-6 border-b border-gray-200">
        <View className="flex-row items-center mb-4">
          <Image
            source={{ uri: profile.avatar_url || 'https://api.dicebear.com/7.x/identicon/svg?seed=' + profile.username }}
          ...
          <View className="flex-1">
            ...
            {profile.bio && (
              <Text className="text-gray-600 mt-1 text-sm">{profile.bio}</Text>
            )}
          </View>
          <TouchableOpacity
