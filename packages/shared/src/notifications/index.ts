...
import type { Json, Notification } from "../types";

type NotificationData = Record<string, Json>;
...
export class NotificationCreators {
  ...
  static async viewProfile(profileOwnerId: string, viewerId: string, viewerUsername: string) {
    return NotificationService.createNotification(
      "profile_view",
      profileOwnerId,
      viewerId,
