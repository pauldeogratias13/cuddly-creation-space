...
const GCS_SEEDS: VideoCandidate[] = [
  {
    title: "Big Buck Bunny", description: "Open animated film by Blender Foundation.",
    author: "Blender Foundation", provider: "Google CDN", kind: "native", category: "Cinema",
    source_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4",
    page_url: "https://peach.blender.org/", poster_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/BigBuckBunny.jpg", duration_label: "9:56",
  },
  {
    title: "Elephant's Dream", description: "First Blender open movie.",
    author: "Blender Foundation", provider: "Google CDN", kind: "native", category: "Cinema",
    source_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4",
    page_url: "https://orange.blender.org/", poster_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/ElephantsDream.jpg", duration_label: "10:53",
  },
  {
    title: "Sintel", description: "Blender Foundation open movie about a girl and her dragon.",
    author: "Blender Foundation", provider: "Google CDN", kind: "native", category: "Cinema",
    source_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4",
    page_url: "https://durian.blender.org/", poster_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/Sintel.jpg", duration_label: "14:48",
  },
  {
    title: "Tears of Steel", description: "Blender sci-fi short film.",
    author: "Blender Foundation", provider: "Google CDN", kind: "native", category: "Cinema",
    source_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4",
    page_url: "https://mango.blender.org/", poster_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/TearsOfSteel.jpg", duration_label: "12:14",
  },
  {
    title: "Subaru Outback Review", description: "Car review sample video.",
    author: "Google", provider: "Google CDN", kind: "native", category: "Series",
    source_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackOnStreetAndDirt.mp4",
    page_url: null, poster_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/SubaruOutbackOnStreetAndDirt.jpg", duration_label: "1:00",
  },
  {
    title: "Volkswagen GTI Review", description: "Car review sample video.",
    author: "Google", provider: "Google CDN", kind: "native", category: "Series",
    source_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/VolkswagenGTIReview.mp4",
    page_url: null, poster_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/VolkswagenGTIReview.jpg", duration_label: "1:00",
  },
  {
    title: "We Are Going On Bullrun", description: "Rally racing sample video.",
    author: "Google", provider: "Google CDN", kind: "native", category: "Docs",
    source_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WeAreGoingOnBullrun.mp4",
    page_url: null, poster_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/WeAreGoingOnBullrun.jpg", duration_label: "0:59",
  },
  {
    title: "For Bigger Blazes", description: "Action sample video.",
    author: "Google", provider: "Google CDN", kind: "native", category: "Series",
    source_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4",
    page_url: null, poster_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/ForBiggerBlazes.jpg", duration_label: "0:15",
  },
  {
    title: "For Bigger Escapes", description: "Adventure sample video.",
    author: "Google", provider: "Google CDN", kind: "native", category: "Series",
    source_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4",
    page_url: null, poster_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/ForBiggerEscapes.jpg", duration_label: "0:15",
  },
  {
    title: "For Bigger Fun", description: "Fun sample video.",
    author: "Google", provider: "Google CDN", kind: "native", category: "Series",
    source_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4",
    page_url: null, poster_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/ForBiggerFun.jpg", duration_label: "0:15",
  },
  {
    title: "For Bigger Joyrides", description: "Joyride sample video.",
    author: "Google", provider: "Google CDN", kind: "native", category: "Series",
    source_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4",
    page_url: null, poster_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/ForBiggerJoyrides.jpg", duration_label: "0:15",
  },
  {
    title: "For Bigger Meltdowns", description: "Intense sample video.",
    author: "Google", provider: "Google CDN", kind: "native", category: "Series",
    source_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4",
    page_url: null, poster_url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/ForBiggerMeltdowns.jpg", duration_label: "0:15",
  },
];
...
async function probeNative(url: string): Promise<boolean> {
  try {
    const head = await timeout(
      ...
      4000, null as unknown as Response
    );
    if (head?.ok) {
...
async function crawlYouTube(
  ...
  for (const { q, category } of queries) {
    try {
      ...
      const detailParams = new URLSearchParams({ part: "contentDetails,status", id: ids.join(","), key: apiKey });
...
async function crawlInternetArchive(
  ...
  for (const { q, category } of queries) {
    try {
      ...
      if (!res?.ok) continue;
      const json = await res.json() as { response?: { docs?: { identifier: string; title?: string; description?: string | string[] }[] } };
      const docs = json.response?.docs ?? [];

      const metaResults = await Promise.allSettled(
        docs.map(async doc => {
          const meta = await timeout(fetch(`https://archive.org/metadata/${doc.identifier}`), 6000, null as unknown as Response);
          ...
          const desc = Array.isArray(doc.description)
            ? String(doc.description[0] ?? "").replace(/<[^>]+>/g, "").slice(0, 400)
            : String(doc.description ?? "").replace(/<[^>]+>/g, "").slice(0, 400);
          return {
...
async function handle(request: Request) {
  ...
  if (purge && existingRows?.length) {
    const all = existingRows as { id: string; source_url: string; kind: string; provider: string }[];
    ...
    const ytIds = youtubeRows.map(r => {
      try { return new URL(r.source_url).searchParams.get("v") ?? ""; } catch { return ""; }
    });
    const ytPlayable = await probeAll(ytIds, id => id ? probeYouTube(id) : Promise.resolve(false), 15);

    // Probe native via HEAD
    const nativePlayable = await probeAll(nativeRows.map(r => r.source_url), probeNative, 10);

    const brokenIds: string[] = [];
    youtubeRows.forEach((r, i) => { if (!ytPlayable[i]) brokenIds.push(r.id); });
    nativeRows.forEach((r, i) => { if (!nativePlayable[i]) brokenIds.push(r.id); });
      ...
      if (!delErr) {
        ...
        for (const id of brokenIds) {
          for (const [url, rid] of existingMap) {
            if (rid === id) { existingMap.delete(url); break; }
          }
        }
      }
    }
  ...
  const ytNewIds = youtubeNew.map(c => {
    try { return new URL(c.source_url).searchParams.get("v") ?? ""; } catch { return ""; }
  });
  const ytNewPlayable = await probeAll(ytNewIds, id => id ? probeYouTube(id) : Promise.resolve(false), 15);
  const nativeNewPlayable = await probeAll(nativeNew.map(c => c.source_url), probeNative, 10);

  const verifiedCandidates: VideoCandidate[] = [];
  youtubeNew.forEach((c, i) => { if (ytNewPlayable[i]) verifiedCandidates.push(c); });
  nativeNew.forEach((c, i) => { if (nativeNewPlayable[i]) verifiedCandidates.push(c); });
